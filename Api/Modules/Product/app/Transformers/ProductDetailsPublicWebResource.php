...
use App\Http\Resources\ProductFullSpecificationsPublicResource;
use Illuminate\Http\Request;
use Illuminate\Http\Resources\Json\JsonResource;

class ProductDetailsPublicWebResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'variants' => ProductVariantPublicWebResource::collection($this->variants),
            'views' => $this->views,
            'status' => $this->status,
            ...
            'wishlist' => auth('api_customer')->check() ? $this->wishlist : false,
