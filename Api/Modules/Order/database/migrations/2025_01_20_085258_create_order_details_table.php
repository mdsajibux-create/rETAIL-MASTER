...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('order_details', function (Blueprint $table) {
            ...
            $table->string('discount_type')->nullable()->comment('percent/fixed'); // percent/ fixed
            $table->decimal('discount_rate', 15, 2)->nullable(); // 2% or 100-USD
            $table->decimal('discount_amount', 15, 2)->nullable(); // 100
